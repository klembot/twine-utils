...
class Story {
  constructor(props = {}) {
    var _a, _b, _c, _d;
    this.attributes =
      (_a = props.attributes) !== null && _a !== void 0 ? _a : {};
    ...
    this.javascript =
      (_c = props.javascript) !== null && _c !== void 0 ? _c : '';
    this.stylesheet =
      (_d = props.stylesheet) !== null && _d !== void 0 ? _d : '';
  }
  /**
  ...
  loadHtml(source) {
    ...
    this.attributes = Object.assign(Object.assign({}, $story[0].attribs), {
      hidden: undefined
    });
    this.passages = [];
    $story.find('tw-passagedata').each((index, el) => {
      const passage = new passage_1.default().loadHtml(
        cheerio_1.default.html(el)
      );
  ...
  toTwee(tweeVersion = 3, passageSpacer = '\n\n') {
    ...
    if (tweeVersion >= 3) {
      ...
      output += `:: StoryData\n${JSON.stringify(
        Object.assign(Object.assign({}, this.attributes), {name: undefined}),
        null,
        2
      )}`;
    }
