...
export class Story {
    ...
    toHTML() {
        ...
        const script = parse('<div><script role="script" id="twine-user-script" type="text/twine-javascript"></script></div>').querySelector('script');
        const style = parse('<div><style role="stylesheet" id="twine-user-stylesheet" type="text/twine-css"></style></div>').querySelector('style');
